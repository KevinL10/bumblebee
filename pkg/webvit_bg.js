...
export class WasmModel {
    ...
    */
    constructor(weights) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.wasmmodel_load(retptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    predict_image(image) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.wasmmodel_predict_image(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
    ...
    */
    info() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmmodel_info(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
export function __wbg_alert_76b2332093c7f720(arg0, arg1) {
